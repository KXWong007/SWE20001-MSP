    ...
    <body>
        ...
        <section>
            ...
            <div class="main-content">
                ...
                <div class="dashboard">
                    <h2 class="heading"> Menu Items 2 </h2>
                    <?php
                        ...
                        $sql = "SELECT * FROM MenuItems2 ORDER BY $orderBy $order";
                    ...
                    <div class="grid-container">
                        <div>
                            ...
                            <form class="cre-form" action="menu_create2.php" method="post">
                        ...
                        <div>
                            ...
                            <form class="cre-form" action="menu_delete2.php" method="post">
                                <div class="cre-container">
                                    <label for="foodName"><b>Food Name</b></label><br>
                                    <input type="text" placeholder="Enter Food Name" id="foodName" name="foodName" required><br><br>
